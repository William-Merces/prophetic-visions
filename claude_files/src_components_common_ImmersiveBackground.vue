...
export default {
  ...
  computed: {
    ...
    nebulaStyle() {
      const themeColors = {
        celestial: 'rgba(75, 46, 131, 0.15)',
        divine: 'rgba(196, 180, 84, 0.15)',
        prophetic: 'rgba(183, 65, 14, 0.1)',
        dark: 'rgba(20, 20, 20, 0.2)',
        revelation: 'rgba(196, 180, 84, 0.15)' // Alterado para dourado
      };
...
.theme-celestial .nebula-layer {
  background: radial-gradient(ellipse at center, rgba(75, 46, 131, 0.2) 0%, rgba(0, 0, 0, 0) 70%);
}
